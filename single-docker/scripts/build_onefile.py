#!/usr/bin/env python3
"""Cross-platform PyInstaller build for bankingApp-single-docker (onefile)."""
...
def main() -> int:
    ...
    # --onefile: single executable. Antivirus may flag it more often than --onedir.
    # Place data/ and secret/ next to the .exe.
    cmd = [
        "pyinstaller",
        "--onefile",
        "--clean",
    ...
    print(f"\nBuilt {out}")
    print("Deploy: copy the executable and place data/ and secret/ next to it.")
    return 0
