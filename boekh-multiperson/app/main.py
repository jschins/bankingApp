"""FastAPI multi-person boekhouding admin."""
...
app = FastAPI(title="boekhouding", version="0.1", lifespan=lifespan)
...
def run() -> None:
    ...
    init_app()
    print(f"boekhouding admin root: {app_root()}")
    print(f"people: {[p.short for p in get_people()]}")
